...
export const DetailProjectsView = ({ currentTheme }) => {
  ...
  const { tools, title, description, link, rol, problem, understanding, breacking, overall, conclusions } = project;

  const breadcrumbs = [
    <Link to="/projects" key="1" style={{ textDecoration: 'none' }} color={primary}>
    ...
    >
      ...
      <Box width='100%' display='flex' flexDirection='column' gap='16px'>
        ...
        <Typography component='div'>
          ...
          {'\n\n'}
          <List>
            {Object.values(problem.pareto).map(
